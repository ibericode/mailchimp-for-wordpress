...
class ComposerAutoloaderInitadd8dff5101e1d4a15afd6bd1aee7dcd {
	...
	public static function getLoader() {
		...
		spl_autoload_register(array('ComposerAutoloaderInitadd8dff5101e1d4a15afd6bd1aee7dcd', 'loadClassLoader'), true /*, true */);
		self::$loader = $loader = new xrstf_Composer52_ClassLoader();
		spl_autoload_unregister(array('ComposerAutoloaderInitadd8dff5101e1d4a15afd6bd1aee7dcd', 'loadClassLoader'));
