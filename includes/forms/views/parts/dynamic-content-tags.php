    ...
    foreach ($tags as $tag => $config) {
        ...
        <tr>
            <td>
                ...
                <p class="description" style="margin-bottom:0;"><?php echo wp_kses($config['description'], [ 'strong' => [], 'b' => [], 'em' => [], 'i' => [], 'a' => [ 'href' => [] ], 'code' => [] ]); ?></p>
            </td>
        </tr>
        <?php
    }
