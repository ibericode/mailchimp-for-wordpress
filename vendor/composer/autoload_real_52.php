...
class ComposerAutoloaderInitdc8d73488b0d066407623544be6deb12 {
	...
	public static function getLoader() {
		...
		spl_autoload_register(array('ComposerAutoloaderInitdc8d73488b0d066407623544be6deb12', 'loadClassLoader'), true /*, true */);
		self::$loader = $loader = new xrstf_Composer52_ClassLoader();
		spl_autoload_unregister(array('ComposerAutoloaderInitdc8d73488b0d066407623544be6deb12', 'loadClassLoader'));
