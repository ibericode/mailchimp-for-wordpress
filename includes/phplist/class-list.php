...
/**
 * Class PL4WP_PhpList_List
 *
 * Represents a list in PhpList
 *
 * @access public
 */
class PL4WP_PhpList_List {
	...
	/**
	 * @var string Web ID of this list in PhpList.com
	 */
	public $web_id = '';
	...
	/**
	 * @var PL4WP_PhpList_Merge_Field[]
	 */
	public $merge_fields = array();

	/**
	 * @var PL4WP_PhpList_Interest_Category[]
	 */
	...
	public function __construct( $id, $name, $web_id = '' ) {
		...
		// add email field
		$email_field = new PL4WP_PhpList_Merge_Field( 'Email Address', 'email', 'EMAIL', true );
	...
	/**
	 * @param string $tag
	 * @return PL4WP_PhpList_Merge_Field
	 *
	 * @throws Exception
	 */
	 ...
	 * @return PL4WP_PhpList_Interest_Category
	 *
	 * @throws Exception
	 */
	...
	/**
	 * Get link to this list in PhpList
	 *
	 * @return string
	 */
	public function get_web_url() {
		return 'https://admin.phplist.com/lists/members/?id=' . $this->web_id;
	}
	 ...
	 *
	 * @deprecated 4.0
	 * @use PL4WP_PhpList_List::get_interest_category
	 *
	...
	/**
	 * @deprecated 4.0
	 * @use PL4WP_PhpList_List::get_field_by_tag
	 *
	 * @param string $tag
	 *
	 * @return string
