 ...
 * @ignore
 */
function _pl4wp_303_add_monthly_cron_schedule( $schedules ) {
...
add_filter( 'cron_schedules', '_pl4wp_303_add_monthly_cron_schedule', 1 );

// reschedule usage tracking event
wp_clear_scheduled_hook( 'pl4wp_usage_tracking' );
wp_schedule_event( time(), 'monthly', 'pl4wp_usage_tracking' );