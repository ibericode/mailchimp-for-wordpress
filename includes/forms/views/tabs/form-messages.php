...
<table class="form-table mc4wp-form-messages">
	...
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when an email address is successfully subscribed to the selected list(s).', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when an invalid email address is given.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when a required field for the selected list(s) is missing.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when the given email is already subscribed to the selected list(s).', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when a general error occured.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'When using the unsubscribe method, this is the text that shows when the given email address is successfully unsubscribed from the selected list(s).', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'When using the unsubscribe method, this is the text that shows when the given email address is not on the selected list(s).', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'When offering a list choice, this is the text that shows when no lists were selected.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	...
	<tr valign="top" data-showif="<?php echo esc_attr( json_encode( $config ) ); ?>">
		...
		<td>
			...
			<p class="help"><?php echo esc_html__( 'The text that shows when an existing subscriber is updated.', 'mailchimp-for-wp' ); ?></p>
		</td>
	</tr>
	...
	<tr valign="top">
		<th></th>
		<td>
			<p class="help"><?php echo sprintf( esc_html__( 'HTML tags like %s are allowed in the message fields.', 'mailchimp-for-wp' ), '<code>' . esc_html( '<strong><em><a>' ) . '</code>' ); ?></p>
		</td>
	</tr>
