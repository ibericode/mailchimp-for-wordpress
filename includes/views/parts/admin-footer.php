 ...
 * @ignore
 */
function _pl4wp_admin_translation_notice() {
 ...
 * @ignore
 */
function _pl4wp_admin_github_notice() {
 ...
 * @ignore
 */
function _pl4wp_admin_disclaimer_notice() {
	echo '<p class="help">' . __( 'This plugin is not developed by or affiliated with PhpList in any way.', 'phplist-for-wp' ) . '</p>';
}

add_action( 'pl4wp_admin_footer', '_pl4wp_admin_translation_notice' , 20);
add_action( 'pl4wp_admin_footer', '_pl4wp_admin_github_notice', 50 );
add_action( 'pl4wp_admin_footer', '_pl4wp_admin_disclaimer_notice', 80 );
?>
...
<div class="big-margin">
	...
	/**
	 * Runs while printing the footer of every PhpList for WordPress settings page.
	 *
	 * @since 3.0
	 */
	do_action( 'pl4wp_admin_footer' ); ?>
