 ...
 * @ignore
 */
function _pl4wp_admin_sidebar_support_notice() {
	?>
	<div class="pl4wp-box">
 ...
 * @ignore
 */
function _pl4wp_admin_sidebar_other_plugins() {

    echo '<div class="pl4wp-box">';
    echo '<h4 class="pl4wp-title">' . __( 'Other plugins by ibericode', 'phplist-for-wp' ) . '</h4>';
...
add_action( 'pl4wp_admin_sidebar', '_pl4wp_admin_sidebar_other_plugins', 40 );
add_action( 'pl4wp_admin_sidebar', '_pl4wp_admin_sidebar_support_notice', 50 );

/**
 * Runs when the sidebar is outputted on PhpList for WordPress settings pages.
 *
 * Please note that not all pages have a sidebar.
 *
 * @since 3.0
 */
do_action( 'pl4wp_admin_sidebar' );
