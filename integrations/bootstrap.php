...
mc4wp_add_integration( 'contact-form-7', 'MC4WP_Contact_Form_7_Integration', true );
mc4wp_add_integration( 'events-manager', 'MC4WP_Events_Manager_Integration', true );
mc4wp_add_integration( 'custom', 'MC4WP_Custom_Integration', true );