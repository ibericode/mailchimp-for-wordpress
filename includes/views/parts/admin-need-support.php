...
<div class="mc4wp-box">
	...
	<ul class="ul-square">
		...
		<li><?php echo sprintf( __( 'Review the plugin on your blog and link to <a href="%s">the plugin page</a>.', 'mailchimp-for-wp' ), 'https://mc4wp.com/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=show-appreciation' ) . ' ' . __( 'There is an <a href="%s">affiliate program</a> as well.', 'mailchimp-for-wp' ); ?></li>
