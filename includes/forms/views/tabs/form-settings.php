...
<table class="form-table" style="table-layout: fixed;">
    ...
    <tr valign="top">
        <th scope="row"><label for="mc4wp_form_subscriber_tags"><?php echo esc_html__('Add Subscriber tags', 'mailchimp-for-wp'); ?></label></th>
        <td>
    ...
    <tr valign="top">
        <th scope="row"><label for="mc4wp_form_remove_subscriber_tags"><?php echo esc_html__('Remove subscriber tags', 'mailchimp-for-wp'); ?></label></th>
        <td>
            <input type="text" class="widefat" name="mc4wp_form[settings][remove_subscriber_tags]" id="mc4wp_form_remove_subscriber_tags" placeholder="<?php echo esc_attr__('Example: Old tag, another tag', 'mailchimp-for-wp'); ?>" value="<?php echo esc_attr($opts['remove_subscriber_tags']); ?>" />
            <p class="description">
