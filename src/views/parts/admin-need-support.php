...
<div class="mc4wp-box">
	...
	<ul class="ul-square">
		...
		<li><a target="_blank" href="https://twitter.com/?status=<?php echo urlencode( __( 'I am using MailChimp for WordPress by @ibericode - it is great!', 'mailchimp-for-wp' ) . ' > https://mc4wp.com/' ); ?>"><?php _e( 'Tweet about MailChimp for WordPress', 'mailchimp-for-wp' ); ?></a></li>
